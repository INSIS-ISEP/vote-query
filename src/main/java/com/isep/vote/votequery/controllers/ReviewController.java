...
// package com.isep.vote.voteserviceapi.controllers;
...
// import com.isep.vote.voteserviceapi.model.*;
// import com.isep.vote.voteserviceapi.services.*;
...
// class ReviewController {
    ...
    // public ResponseEntity<Boolean> addVote(@PathVariable(value = "reviewID") final Long reviewID, @RequestBody VoteDTO voteReviewDTO){
